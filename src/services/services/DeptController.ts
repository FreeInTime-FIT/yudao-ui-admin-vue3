...
export async function createDept(body: APITypes.DeptSaveReqVO, options?: { [key: string]: any }) {
...
export async function getDept(params: APITypes.getDeptParams, options?: { [key: string]: any }) {
...
export async function getSimpleDeptList(options?: { [key: string]: any }) {
...
export async function getSimpleDeptList_2(options?: { [key: string]: any }) {
  return request<APITypes.CommonResultListDeptSimpleRespVO>({
...
export async function updateDept(body: APITypes.DeptSaveReqVO, options?: { [key: string]: any }) {
  return request<APITypes.CommonResultBoolean>({
